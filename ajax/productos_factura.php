			  ...
			  <table class="table">
				...
				while ($row=mysqli_fetch_array($query)){
					...
					<tr>
						...
						<td class='text-center'><a  class="btn btn-info" href="#" onclick="agregar('<?php echo $id_producto ?>')"><i class='bx bx-plus-circle' ></i></a></td>
					</tr>
					<?php
				}
				?>
