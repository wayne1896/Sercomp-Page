...
session_start();
	...
	if (empty($_POST['id_cliente'])) {
		...
		$sql="UPDATE factura SET id_cliente='".$id_cliente."', id_empleado='".$id_vendedor."', tipodepago_factura='".$condiciones."', estado_factura='".$estado_factura."' WHERE id_factura='".$id_factura."'";
