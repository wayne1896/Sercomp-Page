...
<div class="modal fade" id="addnew" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
			...
			<form method="POST" action="php\direccion_backend\sector\registroSector.php">
            <h1>Datos Básicos del Inventario</h1>
         

                    <div class="form-group">
                        <label for="inputPassword">Nombre del Sector:</label>
                        <input type="text" class="form-control" name="nombre" id="nombre" placeholder="Ingrese el nombre del Sector"/>
                    </div>
