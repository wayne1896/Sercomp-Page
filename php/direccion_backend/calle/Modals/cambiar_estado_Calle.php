<!-- Delete -->
<div class="modal fade" id="delete_<?php echo $row['id_calle']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
            <center><h4 class="modal-title" id="myModalLabel">Borrar calle</h4></center>
                <button type="button" class="close" data-bs-dismiss="modal" aria-hidden="true">&times;</button>
                
            </div>
            <form method="POST" action="php\direccion_backend\calle\cambiar_estado_Callebd.php?id=<?php echo $row['id_calle']; ?>">
            <div class="modal-body">	
            	<p class="text-center">¿Esta seguro de Borrar el registro?</p>
				<h2 style=”color: #000000;” class="text-center" ><?php echo $row['nombre_calle']; ?></h2>
			</div>
