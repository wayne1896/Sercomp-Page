...
<head>
	<!-- Basic Page Info -->
	<meta charset="utf-8">
	<title>SERCOMP - Cliente nuevo</title>
...
<main class="main" id="skip-target">
    ...
    <form  method="POST"  action="registroclientefac.php?accion=FAC" >
