  ...
  <aside class="sidebar">
    <div class="sidebar-start">
        <div class="sidebar-head">
            <a href="../../menucliente.php" class="logo-wrapper" title="Home">
        ...
        <div class="sidebar-body">
            <ul class="sidebar-body-menu">
                <li>
                    <a class="active" href="../../menucliente.php"><span class="bx bxs-home bx-sm" aria-hidden="true"></span>  Inicio</a>
                </li>
				...
				<li>
                    ...
                    <ul class="cat-sub-menu">
                        <li>
                            <a href="facturaspendientes.php">Facturas pendientes</a>
                        </li>
                        <li>
                            <a href="facturaspagadas.php">Facturas pagadas</a>
                        </li>
                    </ul>
                </li>
                ...
                <li>
                    ...
                    <ul class="cat-sub-menu">
                        <li>
                            <a href="ordensin.php">Orden en proceso</a>
                        </li>
                        <li>
                            <a href="ordenasig.php">Orden finalizadas</a>
                        </li>
                    </ul>
                </li>
    ...
    <div class="sidebar-footer">
	  ...
	  if ($resultado = $mysqli->query($consulta)) {
        ...
        echo"<span class='sidebar-user__title'>".$fila[0]." ". $fila[1].".</span>
                <span class='sidebar-user__subtitle'>Cliente</span>"
                ;}}?>
            </div>
        </a>
    </div>
    ...
    $count = mysqli_num_rows($result);
      ...
      <div class="notification-wrapper">
        ...
        <ul class="users-item-dropdown notification-dropdown dropdown">
          ...
          <li>
            <a class="link-to-page" href="ordenasig.php">Ver ordenes</a>
          </li>
        </ul>
      </div>
      <div class="nav-user-wrapper">
        ...
        <ul class="users-item-dropdown nav-user-dropdown dropdown">
          <li><a href="../../perfilclien.php?id2=<?php echo $id2;?>">
