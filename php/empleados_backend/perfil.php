...
include('../consultas\consultaempleado.php');	

 if(isset($_GET['id2'])){
	$query= perfilempleado($_GET['id2']);
...
<div class="register-page-wrap d-flex align-items-center flex-wrap justify-content-center">
            ...
            <div class="container">    
                  <div class="row">
                      ...
                      <div class="panel-heading">  <h4 >Perfil De: <?php echo $row['nombre_empleado']." ".$row['apellido_empleado'];?></h4></div>
    		...
    		<div class="row">
    			...
    			<div class="form-group">
    				...
    				<input type="text" readonly="" name="nombre" required="" placeholder="Nombre" class="form-control" value="<?php echo $row['nombre_empleado'] ?>">
					<input type="text" readonly="" name="codigo" hidden="true" required="" placeholder="Nombre" class="form-control" value="<?php echo $row['id_empleado'] ?>">
					<?php $_SESSION['codigo']=$row['id_empleado'];
					?>
    			</div>
				</div>
    			...
    			<div class="form-group">
                    ...
                    value="<?php echo $row['nombre_ciudad']." ".$row['nombre_sector']." ".$row['nombre_calle']." Casa No: ".$row['numcasa_empleado']?>">
					...
					<div class="form-group">
						...
						value="<?php echo $row['cedula_empleado']?>">
    			...
    			<div class="form-group">
                    ...
                    value="<?php echo $row['telefono_empleado']?>">
    			...
    			<div class="col-md-4 col-md-offset-0 col-sm-4
    			  ...
    			  <div class="form-group">
                    ...
                    value="<?php echo $row['fechanacimiento_empleado']?>">
		 ...
		 echo "<a href='#edit_".$row['id_empleado']."'  data-toggle='modal' class='btn btn-primary'>Editar</a>'";
		 echo "       "; 
			 $id=$row['id_empleado'];
			 
		
		include('Modals\ActualizarEmpleadoModalperfil.php');
			?>
