    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">	
                ...
                <h2 style=”color: #000000;” class="text-center" > Descripcion</h2>
                <h2 style=”color: #000000;” class="text-center" ><?php echo $row['descripcion_producto']; ?></h2>
			</div>
            <div class="modal-footer">
                ...
                <a href="php\inventario_backend\cambiar_estado_inventariobd.php?id=<?php echo $row['id_producto']; ?>" class="btn btn-danger"><span class="glyphicon glyphicon-trash"></span> Si</a>
            </div>
