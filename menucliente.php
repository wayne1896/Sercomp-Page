...
<?php 
 ...
 unset($_SESSION['message']);
	...
	<div class="card-body">
	  ...
	  $consulta = "SELECT nombre_cliente, apellido_cliente, nombre_ciudad, nombre_sector, nombre_calle, numcasa_cliente FROM cliente e join ciudad c on (c.id_ciudad=e.ciudad_cliente)
	   join sector s on (s.id_sector=e.sector_cliente) join calle k on (k.id_calle=e.calle_cliente)
	    where e.correo_cliente='$id2'";
	  ...
	  if ($resultado = $mysqli->query($consulta)) {
        ...
        echo"<div class='weight-600 font-30 text-blue'>".$fila[0]." ". $fila[1]." !</div>
				...
				<p class='white-block__title'>Cliente</p>
				<p class='white-block__title'>Direccion: ".$fila[2]." ".$fila[3]." ".$fila[4]." Casa #".$fila[5].".</p>
