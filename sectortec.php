                ...
                <thead>
                  <tr class="users-table-info">
							...
							<tbody>
                                    ...
                                    <?php
                                $c=1;
			 			$query=lista_sector($id);
		 				while ( $row= $query->fetch_assoc() ) {
							$estado_cliente=$row["estado_sector"];
							if ($estado_cliente=="Activo"){$text_estado="Activo";$label_class="badge-active";}
		 					...
		 					echo" 
								<tr>
									 ...
									 <a href='calletec.php?id=".$row['id_sector']."' class='btn btn-info'>Ver Calles</a>	 
								
					 				</td>
					 			</tr>
		 					";
							 include('php/direccion_backend/sector/Modals/cambiar_estado_Sector.php');
							 include('php/direccion_backend/sector/Modals/ActualizarSectorsModal.php');
                             $c++;
		 				}
			 			?> 
	   </tbody>
